...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main Content */}
      <div className="flex items-center justify-center min-h-[calc(100vh-160px)] px-4 sm:px-6 py-2">
          ...
          {isSignUp ? (
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 border">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mt-2 text-base">Create Your Donor Account</p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 border">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mt-2 text-base">Register your blood bank</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-xs text-gray-300">Donor Services</p>
                    <p className="text-white font-semibold text-sm">1-888-9DONATE</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <svg className="w-4 h-4 text-red-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">info@oneblood.org</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <svg className="w-4 h-4 text-red-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <p className="text-xs text-gray-300">24/7 Emergency</p>
                    <p className="text-white font-semibold text-sm">1-800-BLOOD-HELP</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-gray-700 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start space-x-4 mb-3 md:mb-0">
              <a href="#" className="text-gray-300 hover:text-red-400 text-xs transition-colors duration-200">Privacy Policy</a>
              <a href="#" className="text-gray-300 hover:text-red-400 text-xs transition-colors duration-200">Terms of Service</a>
              <a href="#" className="text-gray-300 hover:text-red-400 text-xs transition-colors duration-200">Contact Us</a>
              <a href="#" className="text-gray-300 hover:text-red-400 text-xs transition-colors duration-200">FAQs</a>
            </div>
            <div className="text-center">
              <p className="text-gray-400 text-xs">© 2024 OneBlood Inc. All rights reserved. | EIN: 59-3018540</p>
            </div>
          </div>
        </div>
      </footer>
