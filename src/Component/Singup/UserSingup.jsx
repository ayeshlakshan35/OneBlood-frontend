...
export default function Singup({gotoBloodBank,goto}) {
  return (
    <div>
        <div className='space-x-3'>
              <span className='text-2xl font-bold text-center space-x-10 cursor-pointer' >User  </span>
              <span className='text-center text-gray-500 cursor-pointer' onClick={gotoBloodBank}>Blood Bank</span>
              <div>
                <form className='bg-gray-200 w-full max-w-md md:max-w-2xl px-6 sm:px-10 py-10 rounded-lg shadow-md space-y-4'>
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className='w-full md:w-1/2'>
                      ...
                      <input type="text" name="firstName" placeholder="Enter first name" className="w-full p-2 border rounded" />
                    </div>
                    <div className='w-full md:w-1/2'>
